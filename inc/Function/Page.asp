...
Public Function Page( URL , query_string, total, fixed_len, current_page , current_page_value_name, search_keywords, recordCount, recordCountDefine)
	...
	If (current_page - fixed_len <= 1) Then
		i = 1
	Else
		page = page & "<a href=""" & URL & "?" & query_string & current_page_value_name & "_" & 1 & ".html"" class=""a_pagination"" target=""_self"">|<</a> "
		i = current_page - fixed_len
		If (i - fixed_len - 1 <= 0) Then
			page = page & "<a href=""" & URL & "?" & query_string & current_page_value_name & "_" & 1 & ".html"" class=""a_pagination"" target=""_self""><</a> "
		Else
			page = page & "<a href=""" & URL & "?" & query_string & current_page_value_name & "_" & (i - 1) & ".html"" class=""a_pagination"" target=""_self""><</a> "
		End If
	End If
	'12345...
	For i = i To current_page + fixed_len
		...
		Else
			page = page & "<a href=""" & URL & "?" & query_string & current_page_value_name & "_" & i & ".html"" class=""a_pagination"" target=""_self"">[" & i & "]</a> "
		End If
	Next
	'>
	If current_page + fixed_len < total Then
			page = page & "<a href=""" & URL & "?" & query_string & current_page_value_name & "_" & (current_page + fixed_len + 1) & ".html"" class=""a_pagination"" target=""_self"">></a> "
			page = page & "<a href=""" & URL & "?" & query_string & current_page_value_name & "_" & total & ".html"" class=""a_pagination"" target=""_self"">>|</a> "
	End If
	page = page & "&nbsp;&nbsp;"
End Function
'================================================================================
